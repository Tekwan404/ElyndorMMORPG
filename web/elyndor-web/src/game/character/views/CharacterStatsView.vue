...
const groups: { title: string; description: string; rows: StatRow[] }[] = [
  {
    ...
    rows: [
      { id: 'strength', label: 'Сила', description: 'Повышает физическую силу атаки. При экипированном щите также увеличивает силу блока; сама по себе не даёт броню или шанс блока.' },
      ...
      { id: 'stamina', label: 'Выносливость', description: 'Увеличивает максимальное здоровье и сопротивление магии. Сама по себе не даёт броню.' },
    ],
  },
  {
    title: 'Атака',
    ...
    rows: [
      { id: 'attackPower', label: 'Сила атаки', description: 'Основной показатель физического урона. Складывается из Силы, Ловкости, экипировки и талантов по серверной формуле.' },
      { id: 'spellPower', label: 'Сила заклинаний', description: 'Определяет мощность магических способностей и зависит от Интеллекта, экипировки и талантов.' },
