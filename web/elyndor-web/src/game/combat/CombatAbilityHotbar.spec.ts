...
describe('CombatAbilityHotbar', () => {
  ...
  it('does not swallow another ability after a cancelled long-press inspection', async () => {
    vi.useFakeTimers()
  ...
  it('does not swallow the inspected ability after pointerleave cancelled the gesture', async () => {
    vi.useFakeTimers()
    const wrapper = mountHotbar()
    const strike = wrapper.get('[data-ability-slot="TEST_STRIKE"]')
