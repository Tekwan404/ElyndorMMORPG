...
<template>
  <button class="store-product" :class="[`store-product--${layout}`, `store-product--art-${product.artwork}`]" type="button" @click="emit('open', props.product)">
