  ...
  nodes: [
    {
      ...
      unlockedAbilityId: 'MAGE_FIREBALL', unlockedAbilityName: 'Огненный шар',
    ...
    },
    {
      ...
      prerequisites: [], requiredLevel: null, iconId: null, runtimeStatus: 'SUPPORTED',
      unlockedAbilityId: 'ARCANE_BURST', unlockedAbilityName: 'Тайный взрыв',
    ...
    },
    {
      ...
      prerequisites: [], requiredLevel: null, iconId: null, runtimeStatus: 'SUPPORTED',
      unlockedAbilityId: 'HEART_OF_WINTER', unlockedAbilityName: 'Сердце зимы',
