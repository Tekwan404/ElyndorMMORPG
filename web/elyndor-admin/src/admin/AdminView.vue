...
<style scoped>
.admin-shell { min-height: auto; padding: 0; background: transparent; color: var(--ui-color-text-primary); }
...
.workspace-badge { padding: var(--ui-space-1) var(--ui-space-2); border: 1px solid var(--ui-color-primary); border-radius: var(--ui-radius-round); color: var(--ui-color-primary); font-size: var(--ui-font-size-xs); }
