...
Document: docs/source-of-truth/gameplay/14_LOOT_SYSTEM.md
System: Loot / Rewards
...
Currency System существует как `docs/source-of-truth/gameplay/26_CURRENCY_AND_ECONOMY_SYSTEM.md`.
