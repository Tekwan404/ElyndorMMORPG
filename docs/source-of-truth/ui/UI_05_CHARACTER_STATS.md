...
**Document:** `docs/source-of-truth/ui/UI_05_CHARACTER_STATS.md`
...
Он использует только утверждённые Stats из `docs/source-of-truth/gameplay/06_ATTRIBUTES_AND_STATS_SYSTEM.md` и не вводит скрытых характеристик.
