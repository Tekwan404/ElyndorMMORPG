...
The former `references/PRIMARY_VISUAL_CANON` and `references/STRUCTURE_ONLY` assets were removed from the repository. Use the boards above as the current screen references.
