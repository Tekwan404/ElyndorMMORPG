...
Phase 0 Definition of Done is verified in its phase document. Implement Phase 1 only as bounded vertical slices and do not implement Phase 2+ while Phase 1 is current.
