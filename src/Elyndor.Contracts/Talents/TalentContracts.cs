...
public sealed record LearnTalentRequest(
    string TalentId, string LoadoutId, long ExpectedStateVersion, string MutationId);
public sealed record SwitchTalentLoadoutRequest(
    string LoadoutId, long ExpectedStateVersion, string MutationId);
public sealed record ResetTalentLoadoutRequest(
    string LoadoutId, long ExpectedStateVersion, string MutationId);
