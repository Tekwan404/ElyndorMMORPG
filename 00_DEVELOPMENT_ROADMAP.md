...
**Document:** 00_DEVELOPMENT_ROADMAP.md  
**Status:** Engineering Source of Truth  
**Replaces:** all previous roadmap drafts  
**Stack:** ASP.NET Core .NET 10 · EF Core 10 · PostgreSQL 18 · SignalR · Quartz.NET · Redis · Vue 3 · TypeScript · Telegram Mini App  
...
- конкретные чеклисты исходного `ROADMAP.md`;
...
Visual implementation follows `00_MASTER_UI_REFERENCE.md` and `references/PRIMARY_VISUAL_CANON/`.
